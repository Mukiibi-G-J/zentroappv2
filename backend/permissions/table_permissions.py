...
SOURCE_TABLE_PAGE_ALIASES: dict[str, list[str]] = {
    ...
    'SalesCreditMemo': ['Sales Credit Memo', 'SalesCreditMemoList'],
    'SalesCreditMemoLine': ['Sales Credit Memo', 'SalesCreditMemoList'],
    'PostedSalesInvoice': ['Sales History', 'PostedSalesInvoiceList'],
    'PostedSalesInvoiceLine': ['Sales History', 'PostedSalesInvoiceList'],
    'PurchaseInvoice': ['Purchase Invoices', 'PurchaseInvoiceList'],
    'PurchaseInvoiceLine': ['Purchase Invoices', 'PurchaseInvoiceList'],
    'PostedPurchaseInvoice': ['Purchase History', 'PostedPurchaseInvoiceList'],
    'PostedPurchaseInvoiceLine': ['Purchase History', 'PostedPurchaseInvoiceList'],
    'Expense': ['Expenses', 'ExpenseList', 'Payment History', 'PaymentHistoryList'],
